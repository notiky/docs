...
description: Two-person Notiky setup — co-founder and PM share one workspace, each machine connects as a runtime, and agents run wherever capacity is available.
---

Goal: **a co-founder and a PM (or second founder) share one workspace**, each with their own machine connected as a runtime.

<Frame>
  <img src="/images/recipes/recipe-team-members.png" alt="Settings Members tab with workspace owner and pending invite" />
</Frame>
...
<Steps>
  ...
  <Step title="Connect Alex's machine">
    ...
    <Frame>
      <img src="/images/guides/quickstart-new-agent.png" alt="New agent dialog" />
    </Frame>
  </Step>
  ...
  <Step title="Run a joint dry run">
    ...
    <Frame>
      <img src="/images/guides/welcome-board.png" alt="Shared tasks board with agent and member assignments" />
    </Frame>
  </Step>
</Steps>
