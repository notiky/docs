...
description: PM workflow for turning a product decision into shipped work — think it through in a Conversation, draft tasks in Plan mode, then assign an agent to build.
---

Goal: **turn a product decision into assigned work** without losing context between chat and the board.

<Frame>
  <img src="/images/recipes/recipe-decision-plan.png" alt="Conversation in Plan mode shaping a product decision" />
</Frame>
...
<Steps>
  ...
  <Step title="Assign implementation">
    ...
    <Frame>
      <img src="/images/guides/tasks-assign-agent.png" alt="Task detail with Builder assigned in Properties" />
    </Frame>
  </Step>
