...
<Steps>
  ...
  <Step title="Assign to an implementation agent">
    ...
    <Frame>
      <img src="/images/tasks-assign.png" alt="Task detail with assignee and status in Properties" />
    </Frame>
  </Step>
  ...
  <Step title="Track in In Progress">
    ...
    <Frame>
      <img src="/images/tasks-in-review.png" alt="Task detail while work is in progress" />
    </Frame>
  </Step>
