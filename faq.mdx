...
<AccordionGroup>
  ...
  <Accordion title="Can one person use Notiky solo?">
    Absolutely. Solo founders use Notiky as a **planning workspace plus agent board** — plan in Conversations, assign implementation to an agent, and keep context on the board while you focus on customers, specs, or sales.
  ...
  <Accordion title="Is there an API for integrations?">
    Start with [Integrations](/developers/integrations) — CLI, MCP, and third-party connectors (Linear, Jira, Notion) are available today. A public REST API reference is not part of this site yet; email [support@notiky.com](mailto:support@notiky.com) for early access questions.
  </Accordion>
